//
//  ChangeHitterMenuViewController.swift
//  scorebook
//
...
class ChangeHitterMenuViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func getTeams(){
        ...
        let filterOut : Set<Lineup> = Set(self.currentTeam.lineupInfo).subtracting(Set(self.currentTeam.mainLineupInfo))
        //        let temp1 : Set<Lineup> = Set(self.currentTeam.lineupInfo).intersection(Set(self.currentTeam.mainLineupInfo))
        self.selectedLineups = Array(filterOut)
